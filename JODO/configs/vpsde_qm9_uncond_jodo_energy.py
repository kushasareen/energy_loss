...
def get_config():
    ...
    data.root = '/home/mila/k/kusha.sareen/scratch/JODO/data/QM9'
    data.name = 'QM9'
    data.processed_file = ''
    data.transform = 'EdgeCom'
    data.collate = 'collate_edge'
    data.info_name = 'qm9_with_h'
    data.num_workers = 4 # was 16
    ...
    training.batch_size = 192 # 128
    training.eval_batch_size = 192 # 128
    training.eval_samples = 192 # 128
    ...
    training.use_energy_loss = True
    training.energy_weight = 1 # TODO
    training.coeff_mode = 'exp' # 'exp', 'inv_dist', 'inv_dist2', 'constant'
