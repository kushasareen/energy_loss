...
def get_config():
    ...
    data.root = '/home/mila/k/kusha.sareen/scratch/JODO/data/geom'
    data.name = 'GeomDrug'
    ...
    training.batch_size = 16*6
    training.eval_batch_size = 16*6
    ...
    training.coeff_mode = 'exp' # 'exp', 'inv_dist', 'inv_dist_sq', 'constant'
